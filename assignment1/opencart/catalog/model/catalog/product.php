...
class ModelCatalogProduct extends Model {
	...
	public function getMostPopularProductIdsByCategory($category_id) {
		$query = $this->db->query("SELECT a.id AS id, MAX( a.c ) FROM (SELECT oc_order_product.product_id AS id, COUNT( * ) AS c FROM oc_order_product INNER JOIN oc_product_to_category ON oc_order_product.product_id = oc_product_to_category.product_id WHERE oc_product_to_category.category_id = " . $category_id ." GROUP BY oc_order_product.product_id) AS a");
