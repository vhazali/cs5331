...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			// Get popular products of same category
			// Get the categories of this product
			$results = $this->model_catalog_product->getCategories($product_info['product_id']);
			$category_count = sizeof($results);
			// Get all the product ids in the same category
			$product_ids = array();
			foreach ($results as $categories) {
				$temp_id = $this->model_catalog_product->getMostPopularProductIdsByCategory($categories['category_id']);
				if ($temp_id != $product_info['product_id'] && $temp_id) {
					$product_ids[] = $temp_id;
				}
			}
			// Remove duplicates
			...
			// Get the relevant info for the popular products
