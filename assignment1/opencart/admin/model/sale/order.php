...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, customer_id, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.referral_id FROM `" . DB_PREFIX . "order` o";
		...
		if (!empty($data['filter_referral_id'])) {
			$sql .= " AND o.referral_id = '" . (int)$data['filter_referral_id'] . "'";
		}
	...
	public function getTotalOrders($data = array()) {
		...
		if (!empty($data['filter_referral_id'])) {
			$sql .= " AND referral_id = '" . (int)$data['filter_referral_id'] . "'";
		}
	...
	public function getTotalOrdersOfCustomer($customer_id, $data = array()) {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order`";
	...
	public function getTotalSalesOfCustomer($customer_id) {
		$query = $this->db->query("SELECT SUM(total) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id > '0' AND customer_id = $customer_id");
	...
	public function getTotalSalesOfCustomerByYear($customer_id, $year) {
		$query = $this->db->query("SELECT SUM(total) AS total FROM `" . DB_PREFIX . "order` WHERE order_status_id > '0' AND YEAR(date_added) = '" . (int)$year . "' AND customer_id = $customer_id");
