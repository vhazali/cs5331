...
// Exports an array of rows into a csv format file
// file_prefix is a string containing the prefix for the exported file name
function export_to_csv($rows, $file_prefix) {
 	...
 	$filename = $file_prefix . "_report_" . date('ymd') . ".csv";
