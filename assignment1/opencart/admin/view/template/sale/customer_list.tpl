        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <td></td>
              <td align="right">
              	<a onclick="getBestCustomer();" class="button"><?php echo $button_best_customer; ?></a>
              	<a onclick="getBestReferrer();" class="button"><?php echo $button_best_referrer; ?></a>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($customer['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><a href="index.php?route=report/sale_customer&customer_id=<?php echo $customer['customer_id']; ?>&token=<?php echo $token; ?>"><?php echo $customer['name']; ?></a></td>
