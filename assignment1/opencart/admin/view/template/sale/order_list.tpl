        ...
        <table class="list">
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="right"><input type="text" name="filter_referral_id" value="<?php echo $filter_referral_id; ?>"></td>
            ...
            <tr>
              ...
              <td class="left"><a href="index.php?route=report/sale_customer&customer_id=<?php echo $order['customer_id']; ?>&token=<?php echo $token; ?>"><?php echo $order['customer']; ?></a></td>
...
function filter() {
	...
	var filter_referral_id = $('input[name=\'filter_referral_id\']').attr('value');
	if (filter_referral_id) {
		url += '&filter_referral_id=' + encodeURIComponent(filter_referral_id);
	}
