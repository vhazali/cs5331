...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_referral_id'])) {
			$filter_referral_id = $this->request->get['filter_referral_id'];
		} else {
			$filter_referral_id = null;
		}
		...
		if (isset($this->request->get['filter_referral_id'])) {
			$url .= '&filter_referral_id=' . urlencode(html_entity_decode($this->request->get['filter_referral_id'], ENT_QUOTES, 'UTF-8'));
		}
		...
		$this->data['filter_referral_id'] = $filter_referral_id;
